...
@section('content')
	<form action="{{route('penroll-save')}}" method="post" id="EnrollForm1">
	        {{ csrf_field() }}
	        <div class="row">
	            <div class="col-sm-6">
	                    ...
	                    <div class="panel-body">
	                        ...
	                        <!--<div class="form-group">
	                            <label for="description">Course</label>
	           					<input type="text" id="course" name="course" class="form-control" placeholder="Enter the Course">
	                        ...
	                        <div class="form-group">
	                            <label for="description">Field</label>
	           					<input type="text" id="field" name="field" class="form-control" placeholder="Enter performance type">
